...
cd /opt/
sed -i "s/xfs     defaults/xfs     noatime,defaults/g" /etc/fstab
...
curl http://192.168.48.4/script/reinforce_safety_OS7-4.sh -O && sh reinforce_safety_OS7-4.sh;rm reinforce_safety_OS7-4.sh
...
curl http://192.168.48.4/script/nic2.sh -O && sh nic2.sh;rm nic2.sh
